import{c as C,a as I,b as S,d as k,e as z,f as h,g as R,u as W,h as y,i as N,j as f,F as E,k as _,l as w,r as D,o as K,m as U,n as s,w as c,p as d,q as M,s as p,t as Q,v as O,x as A}from"./index.e62dbc21.js";import{s as H,N as G,a as V,b as J,c as X,d as j,e as L}from"./socket.ee142b2a.js";function Y(e,t){return C(()=>{for(const n of t)if(e[n]!==void 0)return e[n];return e[t[t.length-1]]})}const Z=e=>{const{textColor1:t,dividerColor:n,fontWeightStrong:i}=e;return{textColor:t,color:n,fontWeight:i}},ee={name:"Divider",common:I,self:Z};var te=ee,re=S("divider",`
 position: relative;
 display: flex;
 width: 100%;
